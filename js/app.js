...
var randomSpeed = function(lower_limit,upper_limit){
...
var Enemy = function(x,y) {
    ...
    this.maxSpeed = 400;
    this.minSpeed = 100;
    this.speed = randomSpeed(this.maxSpeed,this.minSpeed);
...
// Parameter: dt, a time delta between ticks
    Enemy.prototype.update = function(dt) {
        ...
        // all computers.
        if(this.x > 550){
            this.speed = randomSpeed(400,100);
            this.x = -50;
        }
    };
...
var Player = function(x,y) {
    this.x = x;
    this.y = y;
    this.sprite =playerImages[randomSpeed(0,4)];
};
